package com.globant.romanNumbersConverter;
...
public class RomanNumbersConverter {
	...
	public void testConvertRomanNumberToDecimal() {
		assertEquals(2015, romanToDecimal("MMXV"));
	}

	@Test
	public void testConvertDecimalNumberToRoman() {
		assertEquals("MMCMXIV", decimalToRoman(2914));
	}
